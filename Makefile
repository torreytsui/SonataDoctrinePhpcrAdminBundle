...
test:
	SYMFONY_PHPUNIT_DIR=.phpunit SYMFONY_PHPUNIT_REMOVE="symfony/yaml" KERNEL_CLASS="Sonata\\DoctrinePHPCRAdminBundle\\Tests\\Fixtures\\App\\Kernel" SYMFONY_PHPUNIT_VERSION=5.7 ./vendor/bin/simple-phpunit -c phpunit.xml.dist --coverage-clover build/logs/clover.xml
.PHONY: test
